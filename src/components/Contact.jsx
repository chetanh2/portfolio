  ...
  return (
    <div className='border-t border-stone-900 pb-20'>
        ...
        <div className="text-center tracking-tighter">
            ...
            <motion.a href={`tel:${CONTACT.phoneNo}`} whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: 100 }} transition={{ duration: 1 }} className='my-4 block'>{CONTACT.phoneNo}</motion.a>
            <a href="mailto:gudigarchetan@gmail.com" className='border-b'>{CONTACT.email}</a>
        </div>
    </div>
  )
}
